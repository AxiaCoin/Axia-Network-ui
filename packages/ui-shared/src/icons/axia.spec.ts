// Copyright 2018-2021 @axia-js/ui-shared authors & contributors
// SPDX-License-Identifier: Apache-2.0

import { axiaIcon } from './axia';

describe('axiaIcon', (): void => {
  it('generates the correct points from known', (): void => {
    expect(
      axiaIcon('5Dqvi1p4C7EhPPFKCixpF3QiaJEaDwWrR9gfWR5eUsfC39TX', { isAlternative: false })
    ).toEqual([
